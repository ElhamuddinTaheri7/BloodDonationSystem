        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('donations.index')" :active="request()->routeIs('donations.index','donations.create','donations.edit','donation_trash')">
                        {{ __('Donate') }}
                    </x-nav-link>
                
                @can('isAdmin')
                    <x-nav-link :href="route('user.index')" :active="request()->routeIs('user.index','user.create','user_trash','user.edit')">
                        {{ __('Users') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin-donations.index')" :active="request()->routeIs('admin-donations.index','admin-donations.create','admin-donations-trash','admin-donations.edit')">
                        {{ __('AdminDonation') }}
                    </x-nav-link>
                @endcan
                    <x-nav-link :href="route('my_messages')" :active="request()->routeIs('my_messages')">
                        {{ __('Message') }}
                    </x-nav-link>
                </div>
            </div>
